...
HUEMatrixEditor::HUEMatrixEditor(QQuickView *view, Doc *doc, QObject *parent)
...
{
    m_view->rootContext()->setContextProperty("hueMatrixEditor", this);
...
HUEMatrixEditor::~HUEMatrixEditor()
{
    m_previewTimer->stop();
    m_view->rootContext()->setContextProperty("hueMatrixEditor", nullptr);
    delete m_previewStepHandler;
}

void HUEMatrixEditor::setFunctionID(quint32 id)
{
    ...
    m_matrix = qobject_cast<HUEMatrix *>(m_doc->function(id));
    if (m_matrix == nullptr)
        return;
...
int HUEMatrixEditor::fixtureGroup() const
{
...
void HUEMatrixEditor::setFixtureGroup(int fixtureGroup)
{
...
QStringList HUEMatrixEditor::algorithms() const
{
    return HUEMatrix::availableAlgorithms(m_doc);
}

int HUEMatrixEditor::algorithmIndex() const
{
...
int HUEMatrixEditor::algoColorsCount() const
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr)
        return 0;
...
QVariantList HUEMatrixEditor::algoColors()
{
    m_algoColors.clear();
...
QColor HUEMatrixEditor::colorAtIndex(int index) const
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr)
        return QColor();
...
void HUEMatrixEditor::setColorAtIndex(int index, QColor color)
{
...
void HUEMatrixEditor::resetColorAtIndex(int index)
{
...
bool HUEMatrixEditor::hasColorAtIndex(int index) const
{
    if (m_matrix == nullptr || m_matrix->getColor(index).isValid() == false)
        return false;
...
void HUEMatrixEditor::updateColors()
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr)
        return;
...
QString HUEMatrixEditor::algoText() const
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr &&
...
void HUEMatrixEditor::setAlgoText(QString text)
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr &&
        m_matrix->algorithm()->type() == RGBAlgorithm::Text)
    {
...
QFont HUEMatrixEditor::algoTextFont() const
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr &&
        m_matrix->algorithm()->type() == RGBAlgorithm::Text)
    {
...
void HUEMatrixEditor::setAlgoTextFont(QFont algoTextFont)
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr &&
        m_matrix->algorithm()->type() == RGBAlgorithm::Text)
    {
...
QString HUEMatrixEditor::algoImagePath() const
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr &&
...
void HUEMatrixEditor::setAlgoImagePath(QString path)
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr &&
        m_matrix->algorithm()->type() == RGBAlgorithm::Image)
    {
...
QSize HUEMatrixEditor::algoOffset() const
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr)
    {
...
void HUEMatrixEditor::setAlgoOffset(QSize algoOffset)
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr)
    {
        if (m_matrix->algorithm()->type() == RGBAlgorithm::Image)
...
int HUEMatrixEditor::animationStyle() const
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr)
    {
        if (m_matrix->algorithm()->type() == RGBAlgorithm::Image)
...
void HUEMatrixEditor::setAnimationStyle(int style)
{
    if (m_matrix != nullptr && m_matrix->algorithm() != nullptr)
    {
        if (m_matrix->algorithm()->type() == RGBAlgorithm::Image)
...
void HUEMatrixEditor::createScriptObjects(QQuickItem *parent)
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr ||
...
void HUEMatrixEditor::setScriptStringProperty(QString paramName, QString value)
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr ||
        m_matrix->algorithm()->type() != RGBAlgorithm::Script)
            return;
...
void HUEMatrixEditor::setScriptIntProperty(QString paramName, int value)
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr ||
        m_matrix->algorithm()->type() != RGBAlgorithm::Script)
            return;
...
void HUEMatrixEditor::setScriptFloatProperty(QString paramName, double value)
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr ||
        m_matrix->algorithm()->type() != RGBAlgorithm::Script)
        return;
...
int HUEMatrixEditor::blendMode() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setBlendMode(int mode)
{
...
int HUEMatrixEditor::controlMode() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setControlMode(int mode)
{
...
int HUEMatrixEditor::rotation() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setRotation(int r)
{
...
int HUEMatrixEditor::mirror() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setMirror(int m)
{
...
int HUEMatrixEditor::mirrorBlend() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setMirrorBlend(int b)
{
    if (m_matrix == nullptr || b == m_matrix->mirrorBlend())
        return;
    m_matrix->setMirrorBlend(HUEMatrix::MirrorBlend(b));
    initPreviewData();
...
void HUEMatrixEditor::setBrightness(qreal b)
{
...
int HUEMatrixEditor::beatEffect() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setBeatEffect(int e)
{
    if (m_matrix == nullptr || e == m_matrix->beatEffect())
        return;
    m_matrix->setBeatEffect(HUEMatrix::BeatEffect(e));
    initPreviewData();
    emit beatEffectChanged();
}

int HUEMatrixEditor::beatSelection() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setBeatSelection(int s)
{
    if (m_matrix == nullptr || s == m_matrix->beatSelection())
        return;
    m_matrix->setBeatSelection(HUEMatrix::BeatSelection(s));
    initPreviewData();
    emit beatSelectionChanged();
}

int HUEMatrixEditor::beatOrientation() const
{
    if (m_matrix == nullptr)
        return 0;
...
void HUEMatrixEditor::setBeatOrientation(int o)
{
    if (m_matrix == nullptr || o == m_matrix->beatOrientation())
        return;
    m_matrix->setBeatOrientation(HUEMatrix::BeatOrientation(o));
    initPreviewData();
...
bool HUEMatrixEditor::algorithmUsesAudio() const
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr)
        return false;
...
QStringList HUEMatrixEditor::audioInputCategories() const
{
    if (m_matrix == nullptr || m_matrix->algorithm() == nullptr)
        return {};
...
void HUEMatrixEditor::saveToSequence()
{
...
QSize HUEMatrixEditor::previewSize() const
{
    if (m_matrix == nullptr || m_group == nullptr)
        return QSize(0, 0);
...
QVariantList HUEMatrixEditor::previewData() const
{
    return m_previewData;
}

void HUEMatrixEditor::slotPreviewTimeout()
{
...
void HUEMatrixEditor::slotBeatReceived()
{
    m_gotBeat = true;
}

void HUEMatrixEditor::initPreviewData()
{
    m_previewTimer->stop();
    m_previewElapsed = 0;
    m_previewData.clear();
