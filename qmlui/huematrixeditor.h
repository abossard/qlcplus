...
#ifndef HUEMATRIXEDITOR_H
#define HUEMATRIXEDITOR_H
...
class HUEMatrixEditor final : public FunctionEditor
{
    Q_OBJECT
...
public:
    HUEMatrixEditor(QQuickView *view, Doc *doc, QObject *parent = 0);
    ~HUEMatrixEditor();
