...
elseif (APPLE)
    if (DEFINED ENV{QLCPLUS_MAC_APP_DIR})
        set(INSTALLROOT "$ENV{QLCPLUS_MAC_APP_DIR}/Contents")
    else()
        set(INSTALLROOT "${CMAKE_SOURCE_DIR}/dist/QLC+.app/Contents")
    endif()
elseif (UNIX)
    set(INSTALLROOT "/usr")
endif ()
...
# HUE Scripts (HSV contract, used by HUEMatrix)
if (WIN32)
    set(HUESCRIPTDIR "HUEScripts")
    set(USERHUESCRIPTDIR "${USERDATADIR}/HUEScripts")
elseif (APPLE)
    set(HUESCRIPTDIR "${DATADIR}/HUEScripts")
    set(USERHUESCRIPTDIR "${USERDATADIR}/HUEScripts")
else ()
    set(HUESCRIPTDIR "${DATADIR}/huescripts")
    set(USERHUESCRIPTDIR "${USERDATADIR}/huescripts")
