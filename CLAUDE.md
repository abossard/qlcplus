...
HTTP JSON-RPC server on `127.0.0.1:9696/mcp` using the fastmcpp library. Exposes 61 tools for AI agents to query/create/update fixtures, functions, Virtual Console widgets, I/O configuration, and palettes.
